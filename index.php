...
<div class="container">
  ...
  <div class="hero">
    <div class="hero-text">
      ...
      <a href="#" class="btn btn-secondary">Explore Boards</a>
    </div>
    <!-- FIXED: Use web-accessible path -->
...
<div class="cta">
  ...
  <a href="javascript:void(0)" class="btn btn-primary" id="shop-now-btn">Shop Now</a>
  <a href="javascript:void(0)" class="btn btn-secondary" id="explore-boards-btn">Explore Boards</a>
  ...
  <a href="#" id="subscribe-btn" class="btn btn-primary">Subscribe</a>
</div>
